...
module.exports = yeoman.generators.Base.extend({
  ...
  constructor: function () {
    ...
    this.distDir = this.options.dist || 'dist';
  },
  ...
  rewiregrunt: function rewiregrunt() {
